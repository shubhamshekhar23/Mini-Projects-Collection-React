  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.project_container}>
        ...
        <Link to="/spinning-loader" className={styles.yet_implement}>
          Spinning loader
        </Link>
      ...
      <section className={styles.project_container}>
        ...
        <Link className={styles.yet_implement}>chips-input</Link>
        <Link className={styles.yet_implement}>OTP input</Link>
      ...
      <section className={styles.project_container}>
        ...
        <Link className={styles.yet_implement}>Snake Game</Link>
      </section>
